...
const options = [
  {
    ...
    description: 'Our team brings the ride-on mower and handles the job from start to finish.',
    price: '$150/hr',
    note: 'Team of two included',
  },
  {
    icon: Clock,
    title: 'Hire It Yourself',
    description: 'Rent our professional ride-on mower by the day or hour and tackle your property at your own pace.',
    price: '$200/hr',
    note: 'Daily rates available',
  },
  {
    icon: Truck,
    title: 'Transport',
    description: 'We deliver and collect the mower to your property within the service area.',
    price: '$200',
    note: 'Within 20 miles. Additional charges may apply beyond.',
  },
];
